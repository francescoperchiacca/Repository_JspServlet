...
public class MiaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String valoreRichiesto = request.getParameter("funzione");
		String rispostaPagina = "../2ChiamaServlet/index.html";
		
		
		System.out.println("Sono finalmente entrato nella mia Servlet cliccando su: " + valoreRichiesto );
